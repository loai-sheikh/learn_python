...
def getData(operation):
      ...
      try:
            if operation == "encrypt":
                  with open('C:/projects/python/testing/encryption/'+fileName, "r") as f:
                        data = f.read()
...
def fileHandler(operation):
      if data is not None:
            if operation == "encrypt":
                  with open("C:/projects/python/testing/encryption/secret", "wb") as f:
                        f.write(Encrypted)
            elif operation == "decrypt":
                  with open("C:/projects/python/testing/encryption/readable.txt", "w") as f:
                        f.write(decrypted)
